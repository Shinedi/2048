...
//updateBoardView()函数式根据board变量的值对前端的number-cell进行操作
...
//检查有无空余地方
    ...
    //随机一个位置Math.random生成0—1之间的数
    var randx = parseInt( Math.floor( Math.random()  * 4 ) );
    var randy = parseInt( Math.floor( Math.random()  * 4 ) );

   var times = 0;
   //检查randx，randy这个随机位置是否可用
    while( times < 50 ){
